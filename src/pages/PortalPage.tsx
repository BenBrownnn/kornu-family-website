 ...
 */
 ...
 if (!isAuthenticated) {
 return (
 <div className="min-h-0 bg-gradient-to-br from-gray-900 via-gray-800 to-purple-900 flex items-center justify-center p-4 pt-24">
 ...
 return (
 <div className="min-h-0 bg-[#FAF5EE] pt-0">
 {/* ==================================================================== */}
 {/* HEADER */}
 {/* ==================================================================== */}

 <div className="bg-gradient-to-r from-[#061A33] via-[#023570] to-[#2E1065] relative overflow-visible">
 ...
 <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[#51A2FF] to-[#023570] flex items-center justify-center text-white text-xl font-bold shadow-lg">
 {currentUser?.name
 ?.charAt(0)
 .toUpperCase()}
 </div>
 ...
 <span className="text-[#51A2FF] text-xs font-semibold uppercase tracking-widest">
 Family Portal
 </span>

 {isAdmin && (
 <span className="bg-[#51A2FF] text-[#023570] text-xs px-2 py-0.5 rounded-full font-semibold">
 Admin
 </span>
 )}
 </div>
 ...
 <div className="flex flex-wrap gap-2 mt-4 pb-1 overflow-visible">
 {[
 {
 id: 'dashboard',
 label: 'Dashboard',
 ...
 activeTab === id
 ? 'bg-[#51A2FF] text-[#023570] shadow-md'
 ...
 <div>
 <div className="inline-block bg-[#D0E6FF] text-[#023570] px-4 py-1.5 rounded-full text-sm font-semibold mb-3">
 Your Family Space
 </div>
 ...
 className="portal-card p-6 text-left group bg-white border border-[#D0E6FF] shadow-sm hover:shadow-lg transition-all duration-300"
 >
 <div
 ...
 {count && (
 <span className="text-xs font-semibold bg-[#D0E6FF] text-[#023570] px-2.5 py-1 rounded-full">
 {count}
 </span>
 )}
 </button>
 ...
 <div className="bg-white rounded-2xl shadow-sm border border-[#D0E6FF] p-6">
 ...
 {announcement.priority ===
 'high' && (
 <span className="text-xs bg-[#D0E6FF] text-[#023570] px-2 py-0.5 rounded-full font-semibold">
 Important
 </span>
 )}
 </div>
 ...
 <div className="bg-gradient-to-br from-[#023570] to-[#6A1B9A] rounded-2xl p-8 text-white">
 ...
 <div className="p-6 border-b border-gray-100 bg-gradient-to-r from-[#D0E6FF]/40 to-[#E9D5FF]/40">
 ...
 <div className="p-6 space-y-4 max-h-[500px] overflow-visible">
 {messages.length ===
 0 ? (
 ...
 isMine
 ? 'bg-gradient-to-br from-[#023570] to-[#6A1B9A]'
 ...
 isMine
 ? 'bg-gradient-to-br from-[#023570] to-[#51A2FF] text-white rounded-tr-sm'
 ...
 <div className="w-9 h-9 rounded-full bg-gradient-to-br from-[#023570] to-[#6A1B9A] flex items-center justify-center text-white text-xs font-bold flex-shrink-0">
 {currentUser?.name
 ?.charAt(0)
 .toUpperCase()}
 </div>
 ...
 className="bg-gradient-to-r from-[#023570] to-[#51A2FF] text-white px-4 py-2 rounded-xl font-medium hover:shadow-md transition-all disabled:opacity-50 disabled:cursor-not-allowed"
 >
 {sendingMessage
 ? 'Sending...'
 : 'Send'}
 ...
 className="w-14 h-14 rounded-full object-cover flex-shrink-0 ring-2 ring-[#D0E6FF]"
 onError={(
 event
 ) => {
 const target =
 ...
 <p className="text-[#51A2FF] text-xs font-medium">
 {
 member.role
 }
 </p>
 ...
 <span className="text-xs font-semibold uppercase tracking-wider text-[#51A2FF]">
 {
 marriage.status
 }
 </span>
 ...
 <div className="bg-[#D0E6FF] rounded-xl px-4 py-3 min-w-[150px]">
 <div className="text-2xl font-black text-[#51A2FF]">
 {
 children.length
 }
 </div>
 ...
 {treeSearch.trim() && (
 <div className="absolute left-0 right-0 top-full z-30 mt-2 max-h-60 overflow-visible rounded-xl border border-gray-100 bg-white p-2 shadow-lg">
 {dbMembers
 .filter((member) =>
 member.name
 .toLowerCase()
 ...
 <div className="w-16 h-16 flex-shrink-0 bg-gradient-to-br from-[#51A2FF] to-[#023570] rounded-xl flex flex-col items-center justify-center text-white">
 ...
 <span className="text-xs bg-[#D0E6FF] text-[#023570] px-2.5 py-1 rounded-full font-semibold capitalize">
 {
 event.type
 }
 </span>
 ...
 {announcement.priority ===
 'high' && (
 <span className="text-xs bg-[#D0E6FF] text-[#023570] px-2.5 py-1 rounded-full font-semibold">
 Important
 </span>
 )}
 ...
 >
 <div
 className="max-h-[90vh] w-full max-w-2xl overflow-visible rounded-3xl bg-white shadow-sm animate-[fadeIn_0.2s_ease-out]"
 role="dialog"
 aria-modal="true"
 ...
 <div className="bg-white rounded-3xl max-w-md w-full p-6 shadow-sm">
 <div className="flex items-center justify-between mb-6">
 <div>
 <h2 className="font-['Montserrat'] text-xl font-bold text-gray-900">
 Add Marriage /
 ...
 {showEventForm && (
 <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
 <div className="bg-white rounded-3xl max-w-md w-full p-6 shadow-sm max-h-[90vh] overflow-visible">
 <div className="flex items-center justify-between mb-6">
 <h2 className="font-['Montserrat'] text-xl font-bold text-gray-900">
 Add Event
 </h2>
 ...
 <div className="border-2 border-dashed border-gray-200 rounded-2xl p-4 text-center cursor-pointer hover:border-[#51A2FF] transition-colors">
 {eventImagePreview ? (
 <img
 src={
 eventImagePreview
