...
export default function StoriesPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF5EE] text-[#102A43]">
      ...
      <section className="relative min-h-[560px] overflow-hidden text-white">
        ...
        <div className="relative z-10 mx-auto flex min-h-[560px] max-w-6xl items-center px-4 py-20">
          <div className="max-w-3xl">
            ...
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-2 text-sm font-semibold text-blue-100 backdrop-blur-md">
              <BookOpen
                size={15}
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between border-t border-[#EEF2F6] pt-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="flex items-center gap-1 text-xs text-[#8796A5]">
                        <MessageCircle
                          size={13}
                        />
      ...
      {selectedStory && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={closeStoryModal}
              className="absolute right-4 top-4 z-10 flex h-10 w-10 items-center justify-center rounded-full bg-[#023570]/80 text-white backdrop-blur-md transition hover:bg-[#2E1065]"
      ...
      {showStoryForm && (
        <div
          className="fixed inset-0 z-50 flex items-center justify-center bg-[#023570]/80 p-4 backdrop-blur-sm"
          onClick={() =>
            setShowStoryForm(false)
          }
        >
